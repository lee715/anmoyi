...
(function() {
  var MP_API, _, config, db, moment, qs, redis, sendPayTmp, sockSrv, subscribe, weixinAPI;
  ...
  module.exports = function(message) {
    ...
    weixinAPI.getUserInfo(fromusername, function(err, user) {
      return db.alien.findOneAsync({
        ...
        return console.log('alien', alien);
      })["catch"](function(e) {
      ...
      if (event === 'subscribe') {
        ...
        if (eventkey === 'how_to_use') {
          ...
          return db.order.findAsync({
            ...
            return sockSrv.startAsync(order.uid, order.time).then(function() {
