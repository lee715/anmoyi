...
(function() {
  ...
  define(['jquery', 'backbone', 'data', 'text!templates/layer.ejs', 'views/devices', 'views/users', 'views/places', 'views/placesWithStatistic', 'views/createDevice', 'views/createUser', 'views/coupons', 'views/createPlace', 'views/createType', 'views/reconciliation', 'views/login', 'views/orders'], function($, B, Data, layerTemp, devicesView, usersView, placesView, placesDetailView, createDeviceView, createUserView, couponsView, createPlaceView, createTypeView, reconciliationView, loginView, ordersView) {
    ...
    return Layer = (function(superClass) {
      ...
      Layer.prototype.renderSubView = function() {
        switch (this._route) {
          case 'coupons':
            return this._views.coupons = new couponsView({
              el: this.$main[0]
            });
          case 'devices':
